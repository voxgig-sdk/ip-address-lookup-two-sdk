...
// instead of `sdk.NewIpAddressLookupTwoSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *IpAddressLookupTwoSDK  { return NewIpAddressLookupTwoSDK(nil) }
func Test() *IpAddressLookupTwoSDK { return TestSDK(nil, nil) }
