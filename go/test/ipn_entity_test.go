...
func TestIpnEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set IPADDRESSLOOKUPTWO_TEST_IPN_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func ipnBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("IPADDRESSLOOKUPTWO_TEST_IPN_ENTID")
