...
// IpAddressLookupTwo SDK streaming feature
...
class IpAddressLookupTwoStreamingFeature extends IpAddressLookupTwoBaseFeature
{
    ...
    private function _iterate(IpAddressLookupTwoResult $result): \Generator
    {
    ...
    private function _streamable(IpAddressLookupTwoContext $ctx): bool
    {
