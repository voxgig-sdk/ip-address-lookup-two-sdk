...
// IpAddressLookupTwo SDK debug feature
...
class IpAddressLookupTwoDebugFeature extends IpAddressLookupTwoBaseFeature
{
    ...
    private function _finish(IpAddressLookupTwoContext $ctx, bool $ok): void
    {
