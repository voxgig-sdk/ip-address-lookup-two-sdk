...
// IpAddressLookupTwo SDK audit feature
...
class IpAddressLookupTwoAuditFeature extends IpAddressLookupTwoBaseFeature
{
    ...
    private function _emit(IpAddressLookupTwoContext $ctx, string $outcome): void
    {
