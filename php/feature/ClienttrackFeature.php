...
// IpAddressLookupTwo SDK clienttrack feature
...
class IpAddressLookupTwoClienttrackFeature extends IpAddressLookupTwoBaseFeature
{
    ...
    public function PostConstruct(IpAddressLookupTwoContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'IpAddressLookupTwo-SDK';
