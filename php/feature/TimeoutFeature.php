...
// IpAddressLookupTwo SDK timeout feature
...
class IpAddressLookupTwoTimeoutFeature extends IpAddressLookupTwoBaseFeature
{
    ...
    private function _with_timeout(IpAddressLookupTwoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(IpAddressLookupTwoContext $_ctx, float $ms): void
    {
        $client = $this->client;
