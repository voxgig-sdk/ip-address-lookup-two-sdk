...
// IpAddressLookupTwo SDK idempotency feature
...
class IpAddressLookupTwoIdempotencyFeature extends IpAddressLookupTwoBaseFeature
{
    ...
    private function _mutating(IpAddressLookupTwoContext $ctx): bool
    {
