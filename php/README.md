...
The PHP SDK for the IpAddressLookupTwo API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Ipn(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->IpAddressLookupTwo(null)->load(
    ["id" => "test01"], null
);
