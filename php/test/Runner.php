...
class IpAddressLookupTwoTestRunner
{
    ...
    {
        $live = self::getenv('IP_ADDRESS_LOOKUP_TWO_TEST_LIVE');
        $override = self::getenv('IP_ADDRESS_LOOKUP_TWO_TEST_OVERRIDE');
        ...
        $explain = self::getenv('IP_ADDRESS_LOOKUP_TWO_TEST_EXPLAIN');
...
class_alias('IpAddressLookupTwoTestRunner', 'Runner');
class_alias('IpAddressLookupTwoHelpers', 'Helpers');
