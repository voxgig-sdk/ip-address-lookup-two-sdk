...
// IpAddressLookupTwo SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (IpAddressLookupTwoSDK::test)
...
{
    private const SDK_CLASS = 'IpAddressLookupTwoSDK';
    ...
    private const SDK_BASE = 'ipaddresslookuptwo_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../ipaddresslookuptwo_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
