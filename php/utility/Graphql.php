...
// IpAddressLookupTwo SDK utility: graphql
//
...
class IpAddressLookupTwoGraphql
{
    ...
    // equivalent.
    public static function body(IpAddressLookupTwoContext $ctx): mixed
    {
    ...
    public static function errors(IpAddressLookupTwoContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
