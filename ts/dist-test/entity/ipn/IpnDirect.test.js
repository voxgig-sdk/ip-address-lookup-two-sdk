...
(0, node_test_1.describe)('IpnDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.IpAddressLookupTwoSDK({
...
function liveScenariosActive() { return false && process.env.IP_ADDRESS_LOOKUP_TWO_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.IpAddressLookupTwoSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['IP_ADDRESS_LOOKUP_TWO_TEST_IPN_ENTID'];
    ...
    const client = new __1.IpAddressLookupTwoSDK({
        base: 'http://localhost:8080',
