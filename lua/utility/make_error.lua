...
local function make_error_util(ctx, err)
  ...
  local msg = "IpAddressLookupTwoSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = IpAddressLookupTwoError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == IpAddressLookupTwoError then
