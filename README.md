...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/ip-address-lookup-two` | `npm install @voxgig-sdk/ip-address-lookup-two` |
| Python | `voxgig-sdk-ip-address-lookup-two` | `pip install voxgig-sdk-ip-address-lookup-two` |
| PHP | `voxgig-sdk/ip-address-lookup-two` | `composer require voxgig-sdk/ip-address-lookup-two` |
| Golang | `github.com/voxgig-sdk/ip-address-lookup-two-sdk/go` | `go get github.com/voxgig-sdk/ip-address-lookup-two-sdk/go` |
| Ruby | `voxgig-sdk-ip-address-lookup-two` | `gem install voxgig-sdk-ip-address-lookup-two` |
| Lua | `voxgig-sdk-ip-address-lookup-two` | `luarocks install voxgig-sdk-ip-address-lookup-two` |
