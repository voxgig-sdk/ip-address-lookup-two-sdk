...
The IPSB API allows you to perform IP address lookups for both IPv4 and IPv6 addresses.

Learn more about IP Address Lookup API at [ip.sb](https://ip.sb).
...
This SDK exposes the API as a small set of **semantic entities** — Ipn — that you
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/ip-address-lookup-two` | publish pending — [install from git tag](https://github.com/voxgig-sdk/ip-address-lookup-two-sdk/releases) |
