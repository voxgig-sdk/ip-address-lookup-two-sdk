...
type Args struct {
	Entity string         `json:"entity" jsonschema:"ipn"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.IpAddressLookupTwoSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "ip-address-lookup-two_list",
		Description: "List records from IpAddressLookupTwo. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "ip-address-lookup-two_load",
		Description: "Load a single record from IpAddressLookupTwo. " +
...
func runOp(client *sdk.IpAddressLookupTwoSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.IpAddressLookupTwoSDK, name string) (sdk.IpAddressLookupTwoEntity, error) {
