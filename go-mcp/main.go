// Command IpAddressLookupTwo-mcp is an MCP server exposing the IpAddressLookupTwo
// SDK as MCP tools.
//
// Two tools are registered:
//
//	IpAddressLookupTwo_list  — list records of an entity
//	IpAddressLookupTwo_load  — load a single record of an entity
//
