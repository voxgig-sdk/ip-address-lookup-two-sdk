# IpAddressLookupTwo SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions IpAddressLookupTwoSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both IpAddressLookupTwoSDK(...) and IpAddressLookupTwoSDK.test(...) become
#      IpAddressLookupTwoSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "ipaddresslookuptwo_sdk"
_SDK_CLASS = "IpAddressLookupTwoSDK"
