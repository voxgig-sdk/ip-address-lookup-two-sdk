...
from ipaddresslookuptwo_sdk.utility import register

# Load features
from ipaddresslookuptwo_sdk.feature.base_feature import IpAddressLookupTwoBaseFeature
from ipaddresslookuptwo_sdk.features import _has_feature, _make_feature
...
class IpAddressLookupTwoSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = IpAddressLookupTwoUtility()
    ...
    def get_utility(self):
        return IpAddressLookupTwoUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("IpAddressLookupTwoSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Ipn(self, data=None) -> "IpnEntity":
        ...
        from ipaddresslookuptwo_sdk.entity.ipn_entity import IpnEntity
