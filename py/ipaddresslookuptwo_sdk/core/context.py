...
from ipaddresslookuptwo_sdk.core.helpers import get_ctx_prop, to_map
...
class IpAddressLookupTwoContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = IpAddressLookupTwoControl()
        ...
        if isinstance(sp, IpAddressLookupTwoSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, IpAddressLookupTwoResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, IpAddressLookupTwoResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return IpAddressLookupTwoOperation({})
    ...
    def make_error(self, code, msg):
        return IpAddressLookupTwoError(code, msg, self)
