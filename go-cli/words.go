...
func registerSDKWords(r *eng.Registry, client *sdk.IpAddressLookupTwoSDK) {
...
func runOp(client *sdk.IpAddressLookupTwoSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
