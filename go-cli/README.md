...
AQL-driven CLI and REPL for the IpAddressLookupTwo SDK. Positional arguments are
...
```sh
go build -o ip-address-lookup-two-cli ./...
```
...
./ip-address-lookup-two-cli list ipn
./ip-address-lookup-two-cli load 1 ipn
./ip-address-lookup-two-cli load '{id:1}' ipn
