...
class IpnEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set IPADDRESSLOOKUPTWO_TEST_IPN_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def ipn_basic_setup(extra)
  ...
  entid_env_raw = ENV["IPADDRESSLOOKUPTWO_TEST_IPN_ENTID"]
