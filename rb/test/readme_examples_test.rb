...
#      offline in seeded test mode (IpAddressLookupTwoSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "IpAddressLookupTwo_sdk.rb")
  SDK_CLASS = "IpAddressLookupTwoSDK"
  ...
  SDK_BASE = "IpAddressLookupTwo_sdk"
