...
require_relative 'IpAddressLookupTwo_types'


class IpAddressLookupTwoSDK
  ...
  def initialize(options = {})
    ...
    utility = IpAddressLookupTwoUtility.new
    @_utility = utility
    ...
    feature_opts = IpAddressLookupTwoHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = IpAddressLookupTwoHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, IpAddressLookupTwoFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    IpAddressLookupTwoUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = IpAddressLookupTwoHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = IpAddressLookupTwoHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = IpAddressLookupTwoHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def op_denied(op)
    ...
    {
      "ok" => false,
      "err" => IpAddressLookupTwoError.new(
        "#{op}_allow",
        "IpAddressLookupTwoSDK: #{op}: operation not allowed by" \
  ...
  def raw_request(fetchargs = {})
    ...
    rescue IpAddressLookupTwoError => err
    ...
    if fetched.is_a?(Hash)
      status = IpAddressLookupTwoHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = IpAddressLookupTwoError.new(
        "graphql_error", "IpAddressLookupTwoSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = IpAddressLookupTwoSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
