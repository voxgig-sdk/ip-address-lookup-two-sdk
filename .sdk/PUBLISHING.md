...
|---|---|---|
| `ts/` | @voxgig-sdk/ip-address-lookup-two-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/ip-address-lookup-two-sdk \
      --repository voxgig-sdk/ip-address-lookup-two-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/ip-address-lookup-two-sdk` shows it, and
`npm trust revoke @voxgig-sdk/ip-address-lookup-two-sdk --id=<id>` removes it.
