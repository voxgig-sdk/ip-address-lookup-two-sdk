...
class IpAddressLookupTwoTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IpAddressLookupTwoTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = IpAddressLookupTwoTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = IpAddressLookupTwoTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
