...
// IpAddressLookupTwo SDK metrics feature
...
class IpAddressLookupTwoMetricsFeature extends IpAddressLookupTwoBaseFeature
{
    ...
    private function _record(IpAddressLookupTwoContext $ctx, bool $ok): void
    {
