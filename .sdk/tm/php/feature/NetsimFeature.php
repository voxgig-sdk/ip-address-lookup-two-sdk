...
// IpAddressLookupTwo SDK netsim feature
...
class IpAddressLookupTwoNetsimFeature extends IpAddressLookupTwoBaseFeature
{
    ...
    private function _simulate(IpAddressLookupTwoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(IpAddressLookupTwoContext $ctx, array $applied): void
    {
        $client = $this->client;
