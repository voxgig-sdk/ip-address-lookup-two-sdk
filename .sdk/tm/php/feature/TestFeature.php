...
// IpAddressLookupTwo SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class IpAddressLookupTwoTestFeature extends IpAddressLookupTwoBaseFeature
{
    ...
    public function init(IpAddressLookupTwoContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (IpAddressLookupTwoContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = IpAddressLookupTwoParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (IpAddressLookupTwoContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(IpAddressLookupTwoContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = IpAddressLookupTwoParam::call($ctx, $k);
