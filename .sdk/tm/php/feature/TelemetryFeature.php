...
// IpAddressLookupTwo SDK telemetry feature
...
class IpAddressLookupTwoTelemetryFeature extends IpAddressLookupTwoBaseFeature
{
    ...
    private function _close(IpAddressLookupTwoContext $ctx, bool $ok): void
    {
