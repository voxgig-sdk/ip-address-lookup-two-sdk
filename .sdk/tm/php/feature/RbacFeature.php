...
// IpAddressLookupTwo SDK rbac feature
...
class IpAddressLookupTwoRbacFeature extends IpAddressLookupTwoBaseFeature
{
    ...
    private function _required(IpAddressLookupTwoContext $ctx): ?string
    {
    ...
    private function _reject(IpAddressLookupTwoContext $ctx, string $required): void
    {
    ...
    private function _track(IpAddressLookupTwoContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
