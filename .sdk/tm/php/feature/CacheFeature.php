...
// IpAddressLookupTwo SDK cache feature
...
class IpAddressLookupTwoCacheFeature extends IpAddressLookupTwoBaseFeature
{
    ...
    private function _through(IpAddressLookupTwoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
