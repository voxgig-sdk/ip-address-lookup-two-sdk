...
// IpAddressLookupTwo SDK ratelimit feature
...
class IpAddressLookupTwoRatelimitFeature extends IpAddressLookupTwoBaseFeature
{
    ...
    private function _acquire(IpAddressLookupTwoContext $ctx): void
    {
    ...
    private function _track(IpAddressLookupTwoContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
