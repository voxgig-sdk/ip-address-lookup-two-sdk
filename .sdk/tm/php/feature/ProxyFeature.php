...
// IpAddressLookupTwo SDK proxy feature
...
class IpAddressLookupTwoProxyFeature extends IpAddressLookupTwoBaseFeature
{
    ...
    public function init(IpAddressLookupTwoContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (IpAddressLookupTwoContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
