...
// IpAddressLookupTwo SDK feature test
//
...
class FtCtrl extends IpAddressLookupTwoControl
{
...
class FtClient
{
    ...
    private IpAddressLookupTwoUtility $utility;

    public function __construct(IpAddressLookupTwoUtility $utility, array $options)
    {
    ...
    public function get_utility(): IpAddressLookupTwoUtility
    {
        return $this->utility;
    }
}
...
class FtRecorder
{
    ...
    {
        return function (IpAddressLookupTwoContext $_ctx, string $url, array $fetchdef): array {
...
class FtHarness
{
    ...
    public IpAddressLookupTwoContext $rootctx;
    ...
    public function __construct(
        ...
        $utility->fetcher = $server ?? function (IpAddressLookupTwoContext $_ctx, string $_url, array $fetchdef): array {
        ...
        foreach ($features as $fspec) {
            ...
            $f = IpAddressLookupTwoConfig::make_feature($name);
    ...
    private static function buildUrl(IpAddressLookupTwoSpec $spec): string
    {
        $keys = [];
    ...
    public function op(array $o = []): array
    {
        ...
        if (($ctx->out['point'] ?? null) instanceof IpAddressLookupTwoError) {
        ...
        if (is_array($fetched)) {
            $ctx->response = new IpAddressLookupTwoResponse($fetched);
        }
    ...
    private function fail(IpAddressLookupTwoContext $ctx, mixed $err): array
    {
...
class FeatureTest extends TestCase
{
    ...
    public function test_retry_retries_a_transport_error_until_exhausted(): void
    {
        ...
        $clock = new FtClock();
        $n = 0;
        $server = function (IpAddressLookupTwoContext $ctx, string $_url, array $_fd) use (&$n): array {
            $n++;
