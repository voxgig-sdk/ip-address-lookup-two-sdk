...
// IpAddressLookupTwo SDK pipeline test
//
...
{
    private static function utility(): IpAddressLookupTwoUtility
    {
        return new IpAddressLookupTwoUtility();
    }
    ...
    private static function ctx(array $over = []): IpAddressLookupTwoContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new IpAddressLookupTwoContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new IpAddressLookupTwoOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof IpAddressLookupTwoError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new IpAddressLookupTwoOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = IpAddressLookupTwoMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new IpAddressLookupTwoOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = IpAddressLookupTwoMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new IpAddressLookupTwoOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = IpAddressLookupTwoMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new IpAddressLookupTwoSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = IpAddressLookupTwoMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new IpAddressLookupTwoResponse([]),
            'result' => new IpAddressLookupTwoResult([]),
        ]);
        [, $err] = IpAddressLookupTwoMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new IpAddressLookupTwoSpec([]),
            'response' => null,
            'result' => new IpAddressLookupTwoResult([]),
        ]);
        [, $err] = IpAddressLookupTwoMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new IpAddressLookupTwoSpec(['step' => 's']),
            'response' => new IpAddressLookupTwoResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new IpAddressLookupTwoResult([]),
        ]);
        [, $err] = IpAddressLookupTwoMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new IpAddressLookupTwoSpec(['step' => 's']),
            'response' => new IpAddressLookupTwoResponse(self::resp(200, ['v' => 1])),
            'result' => new IpAddressLookupTwoResult([]),
        ]);
        [, $err] = IpAddressLookupTwoMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new IpAddressLookupTwoSpec(['step' => 's']),
            'response' => new IpAddressLookupTwoResponse(self::resp(200, ['v' => 2])),
            'result' => new IpAddressLookupTwoResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        IpAddressLookupTwoMakeResponse::call($ctx);
    ...
    {
        $preset = new IpAddressLookupTwoResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new IpAddressLookupTwoSpec([]),
            'response' => new IpAddressLookupTwoResponse([]),
            'result' => new IpAddressLookupTwoResult([]),
        ...
        [$got, $err] = IpAddressLookupTwoMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new IpAddressLookupTwoResult([])]);
        [, $err] = IpAddressLookupTwoMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new IpAddressLookupTwoSpec([]), 'result' => null]);
        [, $err] = IpAddressLookupTwoMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new IpAddressLookupTwoSpec(['step' => 's']),
            'result' => new IpAddressLookupTwoResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new IpAddressLookupTwoOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = IpAddressLookupTwoMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new IpAddressLookupTwoSpec(['step' => 's']),
            'result' => new IpAddressLookupTwoResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new IpAddressLookupTwoOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = IpAddressLookupTwoMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new IpAddressLookupTwoResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new IpAddressLookupTwoSpec([]),
            'result' => new IpAddressLookupTwoResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = IpAddressLookupTwoMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = IpAddressLookupTwoMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new IpAddressLookupTwoError('boom', 'boom');
        $utility->fetcher = function (IpAddressLookupTwoContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new IpAddressLookupTwoSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = IpAddressLookupTwoMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (IpAddressLookupTwoContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = IpAddressLookupTwoMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(IpAddressLookupTwoResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        IpAddressLookupTwoMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (IpAddressLookupTwoContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new IpAddressLookupTwoSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = IpAddressLookupTwoMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new IpAddressLookupTwoResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new IpAddressLookupTwoSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = IpAddressLookupTwoMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = IpAddressLookupTwoMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = IpAddressLookupTwoMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new IpAddressLookupTwoResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, IpAddressLookupTwoDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new IpAddressLookupTwoResult(['ok' => false])]);
        $this->expectException(IpAddressLookupTwoError::class);
        IpAddressLookupTwoDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new IpAddressLookupTwoResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', IpAddressLookupTwoMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        IpAddressLookupTwoMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new IpAddressLookupTwoBaseFeature();
        $b = new IpAddressLookupTwoBaseFeature();
        IpAddressLookupTwoFeatureAdd::call($ctx, $a);
        IpAddressLookupTwoFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): IpAddressLookupTwoBaseFeature
    {
        $f = new IpAddressLookupTwoBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        IpAddressLookupTwoFeatureAdd::call($ctx, self::named_feature('a'));
        IpAddressLookupTwoFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        IpAddressLookupTwoFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        IpAddressLookupTwoFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        IpAddressLookupTwoFeatureAdd::call($ctx, $replace);
        ...
        IpAddressLookupTwoFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): IpAddressLookupTwoContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new IpAddressLookupTwoSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = IpAddressLookupTwoPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        IpAddressLookupTwoPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new IpAddressLookupTwoResponse(['headers' => null]),
            'result' => new IpAddressLookupTwoResult([]),
        ]);
        IpAddressLookupTwoResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        IpAddressLookupTwoResultBody::call($ctx);
