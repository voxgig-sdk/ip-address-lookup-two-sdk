...
// IpAddressLookupTwo SDK utility type

class IpAddressLookupTwoUtility
{
    ...
    public static function copy(IpAddressLookupTwoUtility $src): IpAddressLookupTwoUtility
    {
        $u = new IpAddressLookupTwoUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
