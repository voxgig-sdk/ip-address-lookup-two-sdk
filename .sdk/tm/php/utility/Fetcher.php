...
// IpAddressLookupTwo SDK utility: fetcher

class IpAddressLookupTwoFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; IpAddressLookupTwoSDK/1.0)';
    ...
    public static function call(IpAddressLookupTwoContext $ctx, string $fullurl, array $fetchdef): array
    {
