...
// IpAddressLookupTwo SDK utility: make_options

class IpAddressLookupTwoMakeOptions
{
    ...
    public static function call(IpAddressLookupTwoContext $ctx): array
    {
        ...
        //
        // `IpAddressLookupTwoSchema::optspec()` is built from the model:
        ...
        $optspec = IpAddressLookupTwoSchema::optspec();
